...
**Answer:** Node.js is a JavaScript runtime built on Chrome's V8 JavaScript engine. It allows developers to use JavaScript to write server-side code that can run outside a browser.

### Question: What is the difference between Node.js and JavaScript?
**Answer:** JavaScript is a programming language that runs in browsers, while Node.js is a runtime environment that allows JavaScript to be run on the server.

### Question: What is npm in Node.js?
**Answer:** npm stands for Node Package Manager. It is the default package manager for Node.js and is used to install, update, and manage packages (libraries or modules) in Node.js.

### Question: What are modules in Node.js?
**Answer:** Modules in Node.js are reusable blocks of code whose existence does not affect other code. They can be used to organize code in smaller, maintainable pieces.

### Question: What is the difference between `require()` and `import` in Node.js?
**Answer:** `require()` is the CommonJS module syntax used in Node.js, whereas `import` is ES6 module syntax. Both can be used to import modules, but they are part of different module systems.
...
**Source:** _stackoverflow.com_
### Question: What are async functions in Node? Provide some examples. ☆☆☆☆
...
**Source:** _toptal.com_
### Question: Can Node.js use other engines than V8? ☆☆☆☆☆
...
**Source:** _medium.com_
### Question: How many threads does Node actually create? ☆☆☆☆☆
...
### Question: Explain the result of this code execution ☆☆☆☆☆
...
**Source:** _codementor.io_
### Question: What will happen when that code will be executed? ☆☆☆☆☆
